    ...
    public class SnapGame
    {
		...
		private static void DrawGame(Snap myGame)
		{
			...
			if (top != null)
			{
				...
				SwinGame.DrawText ("Top Card is " + top.ToString (), Color.RoyalBlue, 10, 20);
				SwinGame.DrawText ("Player 1 score: " + myGame.Score(0), Color.Black, "GameFont", 10, 30);
				SwinGame.DrawText ("Player 2 score: " + myGame.Score(1), Color.Red, "GameFont",10, 60);
